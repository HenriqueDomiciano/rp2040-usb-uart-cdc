...
pub async fn uart_bridge_supervisor<R, W>(mut rx: R, mut tx: W, channels: &'static BridgeChannels)
where
...
pub async fn uart_task<R, W>(mut rx: R, mut tx: W, channels: &'static BridgeChannels) -> UartEvent
where
    R: Read,
    W: Write,
{
